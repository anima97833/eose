...
export const DEFAULT_STORE_CATALOG: AppStoreItem[] = [
  ...
  },
  {
    ...
    categoryLabel: '手账',
    iconName: 'GitBranch',
    description: '日常生活与虚拟冒险任务世界线手账，三栏主线、支线与隐藏奇遇。',
  ...
  },
  {
    ...
    categoryLabel: '时光',
    iconName: 'Aperture',
    description: '重要纪念日与生活活动海报展馆，刻画光阴，支持起止日期设定、3D 翻转便签清单与每日开屏主动唤醒。',
    features: ['重要日子海报展馆', '每日开屏晨光展映', '3D 正反面翻转便签', '无图拟物模板速成', 'IndexedDB 永久海量存储'],
    isInstalled: true,
    isSystem: false,
  },
  {
  ...
  },
  {
    ...
    categoryLabel: '背词',
    iconName: 'BookOpen',
    description: '轻拟物沉浸式双语生词小说阅读器，万能书源爬虫、中英混编剧情沉浸阅读与高潮填空挑战。',
    features: ['万能书源跨域爬虫', 'Legado规则导入', '剧情沉浸阅读关卡', '词库难度动态切换', '复仇错词阁沉淀'],
    isInstalled: true,
    isSystem: false,
  },
  {
  ...
  },
  {
    ...
    categoryLabel: '卡带',
    iconName: 'Joystick',
    description: '轻拟物复古卡带游戏仓，集成 Steam 与 App Store 双引擎搜索，随时记录与检视心动在玩/想玩/通关神作。',
